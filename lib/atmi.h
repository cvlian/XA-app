...
#define TPNOCALLBACK	(TPFUNC)
#define TPSPECIFIC	(TPFUNC)
...
#endif
#define TPTCPNODELAY	0x000000200
...
#define WITH_IN_NOCALLBACK		0
#define WITH_OUT_NOCALLBACK	1
...
int __EXPORT tpsetsvctimeout(int sec, long flags);
