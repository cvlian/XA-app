...
struct xa_switch32_t {		/* INFORMIX */
    char name[RMNAMESZ];	/* name of resource manager          */
    int flags;			/* resource manager specific options */
    int version;		/* must be 0 */
    int (*xa_open_entry)(char *, int, int); 	/* xa_open function pointer 	     */
    int (*xa_close_entry)(char *, int, int); 	/* xa_close function pointer         */
    int (*xa_start_entry)(XID32 *, int, int); 	/* xa_start function pointer         */
    int (*xa_end_entry)(XID32 *, int, int); 	/* xa_end function pointer           */
    int (*xa_rollback_entry)(XID32 *, int, int);/* xa_rollback function pointer      */
    int (*xa_prepare_entry)(XID32 *, int, int); /* xa_prepare function pointer       */
    int (*xa_commit_entry)(XID32 *, int, int); 	/* xa_commit function pointer        */
    int (*xa_recover_entry)(XID32 *, int, int, int); /* xa_recover function pointer  */
    int (*xa_forget_entry)(XID32 *, int, int); 	/* xa_forget function pointer        */
    int (*xa_complete_entry)(int *, int *, int, int); /* xa_complete function pointer*/
};
...
#endif
/* ---------- function prototypes ------------ */
int _ax_reg(int, XID *, long);
int _ax_unreg(int, long);
